...
def _replace_director(node):
    node.update({
        ...
        "widgets_values": [
            ...
            "none", "s2-pro-w4a16 (auto download)", "match", "免费智能 1080p", "ai_upscale", "HIGH", "4x-UltraSharpV2.safetensors",
            "{\"version\":1,\"items\":[]}", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            "off", "auto", "auto",
        ],
    ...
    return {
        ...
        "10": {
            ...
            "inputs": {
                ...
                "postprocess_mode": "ai_upscale", "rtx_quality": "HIGH", "ai_upscale_model": "4x-UltraSharpV2.safetensors",
