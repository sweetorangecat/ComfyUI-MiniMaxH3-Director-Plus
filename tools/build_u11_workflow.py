...
def _replace_director(node):
    node.update({
        ...
        "widgets_values": [
            ...
            "none", "s2-pro-w4a16 (auto download)", "match", "智能画质（自动适配）", "video_sr", "HIGH", "auto",
            "{\"version\":1,\"items\":[]}", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            "off", "auto", "auto", "off",
        ],
...
def build_workflow(source):
    ...
    acceleration_note = _note_node(
        ...
        "1080p 使用 H3 单采 + VOSR2 / SeedVR2 视频超分，跳过 H3 二采。480p / 768p 单采输出；低显存档位仍受预算限制。\n\n"
    ...
    return {
        ...
        "10": {
            ...
            "inputs": {
                ...
                "motion_smoothing": "off", "audio_loudness": "auto", "voice_gender": "auto", "face_refine_mode": "off",
