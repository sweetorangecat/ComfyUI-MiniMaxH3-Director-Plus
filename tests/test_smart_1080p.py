...
def test_smart_upscale_model_uses_auto_scale_aware_resolution():
    assert SMART_UPSCALE_MODEL == "auto"
...
def test_low_vram_short_768p_fl_prefers_trained_detail_route_when_ready():
    plan = resolve_smart_1080p_plan(
        "fl2va_model",
        6,
        8,
