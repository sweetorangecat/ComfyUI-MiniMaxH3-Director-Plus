...
function installStyles() {
  ...
  style.textContent = `
    .h3p{box-sizing:border-box;width:100%;min-width:440px;padding:8px;background:#0f151b;color:#d9e4eb;font:12px system-ui,sans-serif;display:flex;flex-direction:column;gap:8px}
    ...
    @media(max-width:640px){.h3p{min-width:320px}.h3p-segments,.h3p-segments.preset{grid-template-columns:repeat(3,minmax(0,1fr))}.h3p-grid,.h3p-materials,.h3p-audio-grid{grid-template-columns:1fr}.h3p-voice{grid-template-columns:1fr}}
  `;
