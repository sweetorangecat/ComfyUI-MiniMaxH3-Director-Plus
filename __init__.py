...
if __package__:
    ...
    from .nodes.action_replace import (
        NODE_CLASS_MAPPINGS as ACTION_NODE_CLASS_MAPPINGS,
        NODE_DISPLAY_NAME_MAPPINGS as ACTION_NODE_DISPLAY_NAME_MAPPINGS,
    )
    ...
    NODE_DISPLAY_NAME_MAPPINGS = {
        ...
        "MiniMaxH3TwoStageSampler": "H3 训练型 3D Latent 二采（自动旁路）",
    ...
    NODE_CLASS_MAPPINGS.update(ACTION_NODE_CLASS_MAPPINGS)
    NODE_DISPLAY_NAME_MAPPINGS.update(ACTION_NODE_DISPLAY_NAME_MAPPINGS)
